...
- [x] Removed redundant toolbar from main window (containing open, save, validate, and correct buttons) as these functions are already available in the menu and navigation bar
...
1. **MainWindow-ChartTab Integration Tests**:
   ...
   - test_chart_creation_from_main_window: Tests chart creation through the MainWindow
   - test_tab_switching_preserves_chart_settings: Ensures chart settings are preserved when switching tabs
   - test_chart_export_from_main_window: Tests chart export functionality from Main
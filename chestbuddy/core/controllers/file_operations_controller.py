...
class FileOperationsController(BaseController):
    ...
    def open_file(self, parent=None):
        ...
        if file_dialog.exec():
            ...
            # Dialog was canceled - emit signal to reset import handling flag in MainWindow
            logger.debug("File dialog canceled by user")
    ...
    def save_file_as(self, parent=None):
        ...
        if file_dialog.exec():
            ...
            # Dialog was canceled - emit signal to reset handling flags in MainWindow

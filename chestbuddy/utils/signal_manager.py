...
class SignalManager:
    ...
    def connect(self, sender: QObject, signal_name: str, 
        ...
        try:
            ...
            if connection_value in self._connections[connection_key]:
                if self._debug_mode:
                    logger.debug(f"Connection already exists: {sender}.{signal_name} -> {receiver}.{slot_name}")
                return False
    ...
    def disconnect(self, sender: QObject, signal_name: str, 
                   ...
                   slot_name: Optional[str] = None) -> int:
        """
    ...
    def get_connections(self, sender: Optional[QObject] = None, 
                        signal_name: Optional[str] = None,
                        receiver: Optional[QObject] = None) -> List[Tuple[QObject, str, QObject, str]]:
        """
